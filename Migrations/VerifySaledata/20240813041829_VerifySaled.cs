...
namespace Realestate.Migrations.VerifySaledata
{
    /// <inheritdoc />
    public partial class VerifySaled : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "VerifySaledatas",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VerifySaledatas", x => x.SaleId);
                });
        }
